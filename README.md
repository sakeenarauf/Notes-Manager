# Notes-Manager
 This is a simple and clean application built entirely in Python. It helps users manage their daily thoughts, to-do items, or quick text snippets directly from the terminal without needing any heavy text editors.
 ## Key Features :
